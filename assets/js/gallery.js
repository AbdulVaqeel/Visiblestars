...
function tabs() {
	...
	var myTabs = document.querySelectorAll("ul.gallery-tabs__nav > li a");
  function myTabClicks(tabClickEvent) {
		...
		var myContentPanes = document.querySelectorAll(".gallery-tabs__pane");
...
window.addEventListener("click", tabs );

...
// Expeirence Field Creation: Start

let er1 = document.querySelector('.become-trainer__row6');
let erb1 = document.querySelector('.add-more-row1');
let erw1 = document.querySelector('.experience-wrapper');

let addit1=()=>{
  let ere1 = er1.cloneNode(true);
  erw1.prepend(ere1)
}

erb1.addEventListener("click", addit1);

// Expeirence Field Creation: End


// Corporate Experience Row: Start

let er2 = document.querySelector('.become-trainer__row7');
let erb2 = document.querySelector('.add-more-row2');
let erw2 = document.querySelector('.training-wrapper');

let addit2=()=>{
  let ere2 = er2.cloneNode(true);
  erw2.prepend(ere2)
}

erb2.addEventListener("click", addit2);

// Corporate Experience Row: End